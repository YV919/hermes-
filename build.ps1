...
$env:GOOS = "windows"
$env:GOARCH = "amd64"
go build -ldflags="-s -w" -o dmxapi-hermes.exe .
...
$env:GOOS = "linux"
$env:GOARCH = "amd64"
go build -ldflags="-s -w" -o dmxapi-hermes-linux-amd64 .
...
$env:GOOS = "linux"
$env:GOARCH = "arm64"
go build -ldflags="-s -w" -o dmxapi-hermes-linux-arm64 .
...
$env:GOOS = "darwin"
$env:GOARCH = "amd64"
go build -ldflags="-s -w" -o dmxapi-hermes-macos-amd64 .
...
$env:GOOS = "darwin"
$env:GOARCH = "arm64"
go build -ldflags="-s -w" -o dmxapi-hermes-macos-arm64 .
...
Get-ChildItem -Name dmxapi-hermes*
